        	...
        	<div class="card-body p-4">
        		...
        		<div class="col-lg-12">
	                <form:form action="change-password.htm?id=${sessionScope.userId}" method="post" modelAttribute="changePassword">
		            	...
		            	<div class="mb-3">
			                <form:label path="newPassword" for="newPassword" class="form-label">New password</form:label>
			                <form:input path="newPassword" type="password" class="form-control" id="newPassword" />
			                <form:errors path="newPassword" cssClass="error" />
		            	</div>
	               
	               		<div class="mb-3">
			                <form:label path="confirmPassword" for="confirmPassword" class="form-label">Confirm password</form:label>
