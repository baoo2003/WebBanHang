						...
						<nav class="sidebar-nav scroll-sidebar" data-simplebar="">
							<ul id="sidebarnav">
								<li class="sidebar-item"><a class="sidebar-link"
										href="${pageContext.request.contextPath}/admin.htm" aria-expanded="false">
										<span> <i class="ti ti-layout-dashboard"></i>
										</span> <span class="hide-menu">Dashboard</span>
									</a></li>
								<li class="sidebar-item"><a class="sidebar-link"
										href="${pageContext.request.contextPath}/products.htm" aria-expanded="false">
										<span> <i class="ti ti-article"></i>
										</span> <span class="hide-menu">Brand</span>
									</a></li>
								<li class="sidebar-item"><a class="sidebar-link"
										href="${pageContext.request.contextPath}/categories.htm" aria-expanded="false">
										<span> <i class="ti ti-article"></i>
										</span> <span class="hide-menu">Category</span>
									</a></li>
								<li class="sidebar-item"><a class="sidebar-link"
										href="${pageContext.request.contextPath}/orders.htm" aria-expanded="false">
										<span> <i class="ti ti-article"></i>
										</span> <span class="hide-menu">Order</span>
									</a></li>
								...
								<div class="sidebar-item" style="position: absolute; bottom: 10px">
									<li class="sidebar-item">
										...
										</form> <a class="sidebar-link"
											href="${pageContext.request.contextPath}/admin/change-password.htm"
											aria-expanded="false"> <span> <i class="ti ti-alert-circle"></i>
											</span> <span class="hide-menu">Change password</span>
										</a>
									</li>
									<li class="sidebar-item">
										<form action="${pageContext.request.contextPath}/logout.htm">
								...
								<%-- <form action="${pageContext.request.contextPath}/logout.htm"> --%>
									...
									<%-- <a class="sidebar-link"
										...
										<%-- <form action="${pageContext.request.contextPath}/logout.htm"> --%>
											...
											<!--                     	</form> -->
											<%-- <a class="sidebar-link"
												href="${pageContext.request.contextPath}/orders.htm"
												aria-expanded="false"> --%>
												<!--                             <span> -->
												<!--                                 <i class="ti ti-login"></i> -->
												<!--                             </span> -->
							...
							<div class="navbar-collapse justify-content-end px-0" id="navbarNav">
								<ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
									<li class="nav-item dropdown"><a class="nav-link nav-icon-hover"
											...
											aria-expanded="false">
											<img src="<c:url value=" /resources/images/profile/user-1.jpg" />"
												...
												<div class="row align-items-center">
													<div class="col-8">
														<h4 class="fw-semibold mb-3">$
															${yearBreakDto.currentYearTotal}</h4>
														<div class="d-flex align-items-center mb-3">

															<c:choose>
																<c:when
																	test="${yearBreakDto.currentYearTotal < yearBreakDto.previousYearToTal}">
																	<span
																		class="me-2 rounded-circle bg-light-danger round-20 d-flex align-items-center justify-content-center">
																		<i
																			class="ti ti-arrow-down-right text-danger"></i>
																	</span>
																	<p class="text-dark me-1 fs-3 mb-0">-
																		${yearBreakDto.percentageChange}</p>
																	<p class="fs-3 mb-0">last year</p>
																</c:when>
																<c:otherwise>
																	<c:if
																		test="${yearBreakDto.previousYearToTal != 0.0}">
																		<span
																			class="me-1 rounded-circle bg-light-success round-20 d-flex align-items-center justify-content-center">
																			<i
																				class="ti ti-arrow-up-left text-success"></i>
																		</span>
																		<p class="text-dark me-1 fs-3 mb-0">+
																			${yearBreakDto.percentageChange}</p>
																		<p class="fs-3 mb-0">last year</p>
																	...
																	<c:if
																		...
																		<p class="fs-3 mb-0">Last year's data is not
																			available</p>
																	</c:if>
														...
														<div class="d-flex align-items-center">
															...
															<div>
																...
																<span class="fs-2">${yearBreakDto.currentYear -
																	1}</span>
															</div>
														</div>
													</div>
												...
												<div class="row alig n-items-start">
													<div class="col-8">
														<h5 class="card-title mb-9 fw-semibold">Monthly
															Earnings</h5>
														<h4 class="fw-semibold mb-3">$
															${salesOverviewDTOs.get(5).total}</h4>
														<div class="d-flex align-items-center pb-1">

															<c:choose>
																<c:when
																	test="${salesOverviewDTOs.get(5).total < salesOverviewDTOs.get(4).total}">
																	<span
																		class="me-2 rounded-circle bg-light-danger round-20 d-flex align-items-center justify-content-center">
																		<i
																			class="ti ti-arrow-down-right text-danger"></i>
																...
																<c:otherwise>
																	<c:if
																		test="${salesOverviewDTOs.get(4).total != 0.0}">
																		<span
																			class="me-1 rounded-circle bg-light-success round-20 d-flex align-items-center justify-content-center">
																			<i
																				class="ti ti-arrow-up-left text-success"></i>
																		</span>
																		<p class="text-dark me-1 fs-3 mb-0">+${pChange}
																		</p>
																		<p class="fs-3 mb-0">last month</p>
																	</c:if>
																	...
																	<c:if
																		...
																		<p class="fs-3 mb-0">Last month's data is not
																			available</p>
																	</c:if>
							...
							<div class="card">
								<div class="card-body">
									<div class="row align-items-start">
										<div class="col-8">
											<h5 class="card-title mb-9 fw-semibold">Total Products
											</h5>
											<h4 class="fw-semibold mb-3">
												${totalProductl}</h4>
										</div>
						...
						<div class="col-lg-4">
							<div class="card">
								<div class="card-body">
									<div class="row align-items-start">
										<div class="col-8">
											<h5 class="card-title mb-9 fw-semibold">Total Customers
											</h5>
											<h4 class="fw-semibold mb-3">
												${totalCustomer}</h4>
										</div>
