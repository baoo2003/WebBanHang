						...
						<div class="d-flex justify-content-between">
							<div class="top-info ps-2">
								<small class="me-3"><i class="fas fa-map-marker-alt me-2 text-secondary"></i> <a
										href="#" class="text-white">97 Man Thien Street, Thu Duc City</a></small> <small
									class="me-3"><i class="fas fa-envelope me-2 text-secondary"></i><a href="#"
						...
						<nav class="navbar navbar-light bg-white navbar-expand-xl">
							...
							<div class="collapse navbar-collapse bg-white" id="navbarCollapse">
								<div class="navbar-nav mx-auto">
									<a href="home.htm" class="nav-item nav-link">Home</a> <a href="cart.htm"
										class="nav-item nav-link">Cart</a> <a href="contact.htm"
						...
						<form action="checkout.htm" method="post">
							<div class="row g-5">
								<div class="col-md-12 col-lg-6 col-xl-7">
										...
										<div class="col-md-12 col-lg-6">
											<div class="form-item w-100">
												<label class="form-label my-3">First Name<sup>*</sup>
													...
													name="firstName" maxlength="50" value="${profileDto.firstName}" />
											</div>
										</div>
										<div class="col-md-12 col-lg-6">
											<div class="form-item w-100">
									...
									<div class="form-item">
										<label class="form-label my-3">Email Address</label> <input type="email"
											class="form-control" name="email" value="${profileDto.email}" />
									</div>
									<div class="form-item">
										<label class="form-label my-3">Mobile<sup>*</sup></label> <input type="tel"
											class="form-control" required name="phoneNumber" maxlength="11"
											value="${profileDto.phoneNumber}" />
									</div>
									<div class="form-item">
										<label class="form-label my-3">Address <sup>*</sup></label> <input type="text"
											class="form-control" placeholder="House Number Street Name" required
											name="address" maxlength="200" value="${profileDto.address}" />
									</div>
									<div class="form-item my-3">
										<textarea name="note" class="form-control" spellcheck="false" cols="30" rows="4"
											placeholder="Order Note" maxlength="200"></textarea>
									</div>
								</div>
										...
										<table class="table">
											...
											<tbody>
													...
													<c:when test="${not empty carts}">
														<c:forEach var="cart" items="${carts}">
															<tr data-product-id="${cart.cartId.productId}"
																...
																<td class="py-5">$${cart.quantity * cart.productPrice}
																</td>
															</tr>
															<c:set var="subTotal"
												...
												<tr>
													...
													<td class="py-5">
														<div class="py-3 border-bottom border-top">
															<p id="totalPrice" class="mb-0 text-dark">$${subTotal}</p>
														</div>
													</td>
												</tr>
											</tbody>
										...
										<div class="col-12">
											<div class="form-check text-start my-3">
												<input type="radio" class="form-check-input bg-primary border-0"
													id="payment-1" name="payment" required value="cod" /> <label
							...
							<div class="col-lg-3 col-md-6">
								<div class="d-flex flex-column text-start footer-item">
									...
									<a class="btn-link" href="">Privacy
										Policy</a> <a class="btn-link" href="">Terms & Condition</a> <a class="btn-link"
										href="">Return Policy</a> <a class="btn-link" href="">FAQs & Help</a>
								</div>
							</div>
							<div class="col-lg-3 col-md-6">
								<div class="d-flex flex-column text-start footer-item">
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-6 my-auto text-center text-md-end text-white">
								Designed By <a class="border-bottom" href="https://github.com/baoo2003">Group 15</a>
